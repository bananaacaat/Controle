...
import ma.sakhr.services.ArticleService;
...
public class ArticleController {
    ...
    public List<Article> findArticleByCategorie(@RequestBody Categorie categorieParent) {
        return service.findByCategorie(categorieParent);
    }
